...
package com.mongodb.cosmosspark.connection

import com.mongodb.{MongoClient, MongoClientOptions, MongoClientURI, MongoDriverInformation}

import scala.util.Try
import com.mongodb.cosmosspark.MongoClientFactory
import com.mongodb.cosmosspark.config.{BuildInfo, MongoSharedConfig, ReadConfig}
import org.apache.spark.SPARK_VERSION

private[cosmosspark] object DefaultMongoClientFactory {
...
private[cosmosspark] case class DefaultMongoClientFactory(connectionString: String, localThreshold: Option[Int] = None) extends MongoClientFactory {

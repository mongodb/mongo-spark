...
import com.mongodb.cosmosspark.exceptions.MongoTypeConversionException
import com.mongodb.cosmosspark.sql.types.BsonCompatibility

private[cosmosspark] object MapFunctions {
  ...
  private[cosmosspark] def rowToDocumentMapper(schema: StructType, extendedBsonTypes: Boolean): (Row) => BsonDocument = {

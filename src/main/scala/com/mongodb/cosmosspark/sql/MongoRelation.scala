...
import com.mongodb.cosmosspark.LoggingTrait
...
import com.mongodb.cosmosspark.sql.MapFunctions.documentToRow
import com.mongodb.cosmosspark.sql.MongoRelationHelper.createPipeline

private[cosmosspark] case class MongoRelation(mongoRDD: MongoRDD[BsonDocument], _schema: Option[StructType])(@transient val sqlContext: SQLContext)

...
import com.mongodb.cosmosspark.rdd.DocumentRDDFunctions
...
package object cosmosspark {
  ...
  private[cosmosspark] def notNull[T](name: String, value: T): Unit = require(Option(value).isDefined, s"$name cannot be null")
}

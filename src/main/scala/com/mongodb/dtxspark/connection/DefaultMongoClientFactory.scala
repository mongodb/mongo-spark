...
package com.mongodb.dtxspark.connection

import com.mongodb.{MongoClient, MongoClientOptions, MongoClientURI, MongoDriverInformation}

import scala.util.Try
import com.mongodb.dtxspark.MongoClientFactory
import com.mongodb.dtxspark.config.{BuildInfo, MongoSharedConfig, ReadConfig}
import org.apache.spark.SPARK_VERSION

private[dtxspark] object DefaultMongoClientFactory {
...
private[dtxspark] case class DefaultMongoClientFactory(connectionString: String, localThreshold: Option[Int] = None) extends MongoClientFactory {

...
import com.mongodb.dtxspark.exceptions.MongoTypeConversionException
import com.mongodb.dtxspark.sql.types.BsonCompatibility

private[dtxspark] object MapFunctions {
  ...
  private[dtxspark] def rowToDocumentMapper(schema: StructType, extendedBsonTypes: Boolean): (Row) => BsonDocument = {

...
package com.mongodb.dtxspark.sql
...
import com.mongodb.dtxspark.LoggingTrait
...
import com.mongodb.dtxspark.sql.MapFunctions.documentToRow
import com.mongodb.dtxspark.sql.MongoRelationHelper.createPipeline

private[dtxspark] case class MongoRelation(mongoRDD: MongoRDD[BsonDocument], _schema: Option[StructType])(@transient val sqlContext: SQLContext)

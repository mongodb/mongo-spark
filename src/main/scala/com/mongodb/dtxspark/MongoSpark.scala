...
import com.mongodb.dtxspark.config.{ReadConfig, WriteConfig}
import com.mongodb.dtxspark.rdd.MongoRDD
import com.mongodb.dtxspark.rdd.api.java.JavaMongoRDD
import com.mongodb.dtxspark.sql.MapFunctions.rowToDocumentMapper
import com.mongodb.dtxspark.sql.{MongoInferSchema, MongoRelation, helpers}
...
object MongoSpark {
  ...
  class Builder {
    ...
    /**
     * Sets the [[com.mongodb.dtxspark.MongoConnector]] to use
     *
    ...
    /**
     * Sets the [[com.mongodb.dtxspark.config.ReadConfig]] to use
     *
   ...
   *
   * @param javaRDD        the RDD data to save to MongoDB
   * @param writeConfig the [[com.mongodb.dtxspark.config.WriteConfig]]
   * @return the javaRDD
   */

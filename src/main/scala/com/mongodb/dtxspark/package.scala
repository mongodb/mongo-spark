...
import com.mongodb.dtxspark.rdd.DocumentRDDFunctions
...
package object dtxspark {
  ...
  private[dtxspark] def notNull[T](name: String, value: T): Unit = require(Option(value).isDefined, s"$name cannot be null")
}

...
import org.apache.spark.sql.{DataFrameReader, DataFrameWriter, Row, SQLContext}
...
package object sql {
   ...
   */
  @DeveloperApi
  implicit def toMongoDataFrameWriterFunctions(dfw: DataFrameWriter[Row]): MongoDataFrameWriterFunctions =

...
public class MongoSparkClientOptionsBuilderInitializer implements MongoClientOptionsBuilderInitializer {
    ...
    /**
     * Constructs an instance. Users should provide a {@code Serializable Supplier<Builder>} function, e.g.
     *
     * <pre>
     * {@code
     ...
     */
    public MongoSparkClientOptionsBuilderInitializer(final Supplier<Builder> builderSupplier) {

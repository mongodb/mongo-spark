...
package com.mongodb.dtxspark.sql.fieldTypes.api.java;

import java.util.regex.Pattern;

import static com.mongodb.dtxspark.sql.fieldTypes.api.java.Assertions.notNull;
...
public final class RegularExpression {
    ...
    public RegularExpression(final Pattern pattern) {
        ...
        com.mongodb.dtxspark.sql.fieldTypes.RegularExpression scalaRegEx = com.mongodb.dtxspark.sql.fieldTypes.RegularExpression.apply(pattern);

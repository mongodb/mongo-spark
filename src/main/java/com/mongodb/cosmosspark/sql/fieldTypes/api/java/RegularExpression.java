...
import static com.mongodb.cosmosspark.sql.fieldTypes.api.java.Assertions.notNull;
...
public final class RegularExpression {
    ...
    public RegularExpression(final Pattern pattern) {
        ...
        com.mongodb.cosmosspark.sql.fieldTypes.RegularExpression scalaRegEx = com.mongodb.cosmosspark.sql.fieldTypes.RegularExpression.apply(pattern);
